...
const FIELD_EXPLANATIONS: Record<string, string> = {
  ...
  'runStats.repair.basePerSecond': 'Starting passive repair rate for structures during active waves.',
  'runStats.repair.perCard': 'Extra repair-per-second granted by each repair card stack.',
  'runStats.repair.maxPerSecond': 'Upper intended cap for repair-per-second tuning.',
  'runStats.repair.tickSeconds': 'How often passive structure repair is applied during active waves.',
  'intermission.towerRefresh.healPercent': 'Percent of structure max HP restored automatically after each cleared wave.',
  'intermission.towerRefresh.flatHeal': 'Flat structure HP added on top of percent-based intermission replenishment.',
  'intermission.towerRefresh.maxStacks': 'Maximum extra stacks allowed from the replenishment card path.',
